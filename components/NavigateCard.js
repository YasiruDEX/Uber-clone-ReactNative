...
const NavigateCard = () => {
  ...
  return (
    <SafeAreaView style={tw`bg-white flex-1`}>
      ...
      <View style={tw`flex-row bg-white justify-evenly py-2 at-auto border-top border-gray-100`}>
        <TouchableOpacity 
        onPress={() => navigation.navigate("RideOptionsCard")}
        style={tw`justify-between flex flex-row bg-black w-24 px-4 py-3 rounded-full`}>
          <Icon
